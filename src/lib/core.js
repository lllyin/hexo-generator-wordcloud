...
const { trimText, stripHtml } = require('../utils/common')
...
function getformatwordclouddata(_text, { trim = true, exclude = true } = {}) {
  const result = fenci(_text, { trim, exclude })
